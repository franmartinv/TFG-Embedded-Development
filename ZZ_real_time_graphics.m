...
while(i<1)
    ...
    header = ["Year" "Month" "Day" "Hour" "Minute" "Second" "MS5611 Temperature [ºC]" "MS5611 Pressure [mBar]" "CCS811 TVOC [ppb]" "CCS811 eco2 [ppm]" "BME680 Temperature [ºC]" "BME680 Pressure [hPa]" "BME680 Humidity [%]"];
